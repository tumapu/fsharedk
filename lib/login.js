...
const loginFshare = async (csrfCode) => {
    try {
        let options = {
            ...
            form: {
                '_csrf-app': csrfCode,
                'LoginForm[email]': 'khoan0823@gmail.com',
                'LoginForm[password]': 'khoanma97',
...
loginFshare('97vKDtaqPRh8ZN8rY80NjE-WK4MOuBpmbNyfPrNxx7qNg5hmmPpuTT5XjAY2vkq4KKNJ7F3qbBEpia1w1jmw3A')
    .then();
